namespace HouseRules.Essentials.Rules
{
    ...
    public sealed class FreeMexicanReplenishablesOnCritRule : Rule, IConfigWritable<List<BoardPieceId>>, IPatchable, IMultiplayerSafe
    {
        ...
        public FreeMexicanReplenishablesOnCritRule(List<BoardPieceId> adjustments)
        {
        ...
        private static void Patch(Harmony harmony)
        {
            harmony.Patch(
                ...
                postfix: new HarmonyMethod(
                    typeof(FreeMexicanReplenishablesOnCritRule),
