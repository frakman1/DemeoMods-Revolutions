namespace HouseRules.Essentials.Rules
{
    ...
    public sealed class AbilityAoeAdjustedRule : Rule, IConfigWritable<Dictionary<AbilityKey, int>>, IMultiplayerSafe
    {
        ...
        private static Dictionary<AbilityKey, int> ReplaceAbilities(Context context, Dictionary<AbilityKey, int> replacements)
        {
            ...
            foreach (var replacement in replacements)
            {
                ...
                var abilityPromise2 = context.AbilityFactory.LoadAbility(AbilityKey.Net);
