namespace HouseRules.Essentials.Rules
{
    ...
    public sealed class PieceStrengthStatAddedRule : Rule, IConfigWritable<Dictionary<BoardPieceId, int>>, IPatchable, IMultiplayerSafe
    {
        public override string Description => "Some Heroes start with a strength bonus";
        ...
        public PieceStrengthStatAddedRule(Dictionary<BoardPieceId, int> adjustments)
        {
        ...
        private static void Patch(Harmony harmony)
        {
            harmony.Patch(
                ...
                postfix: new HarmonyMethod(
                    typeof(PieceStrengthStatAddedRule),
        ...
        private static void CreatePiece_Effects_Postfix(ref Piece __result)
        {
            ...
            foreach (var replacement in _globalAdjustments)
            {
                ...
                {
                    __result.effectSink.TryGetStatMax(Stats.Type.Strength, out int myMaxStrength);
                    __result.effectSink.TrySetStatMaxValue(Stats.Type.Strength, myMaxStrength + replacement.Value);
                    __result.effectSink.TrySetStatBaseValue(Stats.Type.Strength, replacement.Value);
                    return;
                }
            }
        }
