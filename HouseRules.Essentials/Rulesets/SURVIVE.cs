    ...
    internal static class SURVIVE
    {
        internal static Ruleset Create()
        {
            ...
            var piecesAdjustedRule = new PieceConfigAdjustedRule(new List<PieceConfigAdjustedRule.PieceProperty>
            {
                ...
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.ElvenSummoner, Property = "PowerIndex", Value = 2 },
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.ElvenSummoner, Property = "StartHealth", Value = 36 },
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.CavetrollBoss, Property = "PowerIndex", Value = 4 },
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.CavetrollBoss, Property = "StartHealth", Value = 55 },
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.CavetrollBoss, Property = "AttackDamage", Value = 7 },
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.CavetrollBoss, Property = "BerserkBelowHealth", Value = 0.5f },
                ...
                new PieceConfigAdjustedRule.PieceProperty { Piece = BoardPieceId.ElvenQueen, Property = "StartHealth", Value = 95 },
            ...
            var pieceAbilityRule = new PieceAbilityListOverriddenRule(new Dictionary<BoardPieceId, List<AbilityKey>>
            {
                ...
                { BoardPieceId.CavetrollBoss, new List<AbilityKey> { AbilityKey.EnemyMelee, AbilityKey.ElvenKingMeleeWhip, AbilityKey.Zap, AbilityKey.GrapplingSmash } },
                ...
                { BoardPieceId.RootGolem, new List<AbilityKey> { AbilityKey.EnemyMelee, AbilityKey.EnemyKnockbackMelee, AbilityKey.ExplosiveOrb } },
            });
            ...
            var pieceBehaviourListRule = new PieceBehavioursListOverriddenRule(new Dictionary<BoardPieceId, List<Behaviour>>
            {
                ...
                { BoardPieceId.CavetrollBoss, new List<Behaviour> { Behaviour.Patrol, Behaviour.AttackPlayer, Behaviour.RangedSpellCaster } },
                ...
                { BoardPieceId.RootGolem, new List<Behaviour> { Behaviour.Patrol, Behaviour.AttackPlayer, Behaviour.ExplosiveOrb } },
            });
