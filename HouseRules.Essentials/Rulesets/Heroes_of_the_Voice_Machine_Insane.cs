namespace HouseRules.Essentials.Rulesets
{
    ...
    internal static class Heroes_of_the_Voice_Machine_Insane
    {
        internal static Ruleset Create()
        {
            ...
            {
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.Heal, ReplenishFrequency = 0 },
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.StrengthenCourage, ReplenishFrequency = 1 }, // becomes 0AP
            ...
            var guardianCards = new List<StartCardsModifiedRule.CardConfig>
            {
                ...
                // new StartCardsModifiedRule.CardConfig { Card = AbilityKey.SodiumHydroxide, ReplenishFrequency = 0 },
            };
            var hunterCards = new List<StartCardsModifiedRule.CardConfig>
            {
                ...
                // new StartCardsModifiedRule.CardConfig { Card = AbilityKey.RatWhisperer, ReplenishFrequency = 0 },
                // new StartCardsModifiedRule.CardConfig { Card = AbilityKey.RatWhisperer, ReplenishFrequency = 0 },
            ...
            {
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.Heal, ReplenishFrequency = 0 },
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.Stealth, ReplenishFrequency = 1 }, // becomes 0AP
            ...
            var sorcererCards = new List<StartCardsModifiedRule.CardConfig>
            {
                ...
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.Confuse, ReplenishFrequency = 0 },
            };
            // Heroes cahnges.
            ...
            var pieceAbilityRule = new PieceAbilityListOverriddenRule(new Dictionary<BoardPieceId, List<AbilityKey>>
            {
                ...
                { BoardPieceId.GiantSpider, new List<AbilityKey> { AbilityKey.EnemyKnockbackMelee, AbilityKey.SpiderWebshot, AbilityKey.Grab, AbilityKey.PoisonGasGrenade } },
                ...
                { BoardPieceId.RatKing, new List<AbilityKey> { AbilityKey.EnemyMelee, AbilityKey.ElvenKingMeleeWhip, AbilityKey.AcidSpit, AbilityKey.EarthShatter, AbilityKey.PoisonGasGrenade, AbilityKey.RatKingRatBomb, AbilityKey.RatFrenzy, AbilityKey.RatWhisperer, AbilityKey.WaterDive } },
            });
            ...
            var pieceUseWhenKilledRule = new PieceUseWhenKilledOverriddenRule(new Dictionary<BoardPieceId, List<AbilityKey>>
            {
                ...
                { BoardPieceId.RatNest, new List<AbilityKey> { AbilityKey.RatKingRatBomb } },
            });
            ...
            var abilityDamageAllRule = new AbilityDamageAllOverriddenRule(new Dictionary<AbilityKey, List<int>> // target, crit, splash, crit splash.
            {
                ...
                { AbilityKey.GodsFury, new List<int> { 7, 11, 7, 11 } },
                ...
                { AbilityKey.HunterArrow, new List<int> { 3, 7, 3, 7 } },
            ...
            var enemyCooldownRule = new EnemyCooldownOverriddenRule(new Dictionary<AbilityKey, int>
            {
                ...
                { AbilityKey.SpawnSummoningRiftLesser, 4 },
            ...
            {
                { AbilityKey.RatWhisperer, new List<BoardPieceId> { BoardPieceId.KillerBee, BoardPieceId.Spider, BoardPieceId.Spider, BoardPieceId.Spider } },
            });
            ...
            var freeAbilityOnCritRule = new FreeRevolutionsAbilityOnCritRule(new Dictionary<BoardPieceId, AbilityKey>
            {
                ...
                { BoardPieceId.HeroRogue, AbilityKey.ScarePowder },
